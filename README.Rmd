...
```{r echo=FALSE}
library(knitr)
myTable <- data.frame(Modelo = c("Regressão Logística", "Árvore de Regressão", "Floresta aleatória", "Comparação GLM x RF", "One level decision trees"), Desempenho = c(0.75,0.71, 0.74, 0.65, 0.98))
kable(myTable)
```
